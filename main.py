...
def search_knowledge_base(query: str) -> str:
    """
    Search the internal knowledge base (Paul Graham essays stored in Pinecone).
    Use this tool when the user asks about topics covered in the uploaded documents,
    such as startups, founders, essays, or anything Paul Graham wrote about.
    Returns relevant text chunks with page citations.
    Do NOT use this tool for math calculations, general facts, or current events.
    """
    try:
